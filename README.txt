...
Load multiple pieces of Dynamic Content without a performance hit with our new asynchronous loading technique! Go to Settings > Pardot Settings and click "Clear Cache" to update your existing pieces of dynamic content. You can also now add height, width, and additional class parameters.
